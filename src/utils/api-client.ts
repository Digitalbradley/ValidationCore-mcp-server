...
export async function callValidationAPI(endpoint: string, data: any): Promise<AxiosResponse> {
...
export async function callGTINAPI(gtin: string): Promise<AxiosResponse> {
